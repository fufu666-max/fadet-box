...
import {
  JsonRpcProvider,
  ethers_exports
} from "./chunk-MZAIUZD5.js";
import "./chunk-CXSMC4OH.js";
import "./chunk-N4FUJJYF.js";
import {
  __export,
  __toESM,
  require_dist,
...
// node_modules/@fhevm/mock-utils/_esm/index.js
...
var ACL = class _ACL extends FhevmCoprocessorContractWrapper {
  ...
  static async create(runner, aclContractAddress, abi, properties) {
    ...
    __classPrivateFieldSet2(acl, _ACL_fhevmExecutorAddress, properties?.fhevmExecutorAddress, "f");
    __classPrivateFieldSet2(acl, _ACL_version, properties?.version, "f");
...
var FHEVMExecutor = class _FHEVMExecutor extends FhevmCoprocessorContractWrapper {
  ...
  static async create(runner, fhevmExecutorContractAddress, abi, properties) {
    ...
    __classPrivateFieldSet3(fhevmExecutor, _FHEVMExecutor_aclAddress, properties?.aclAddress, "f");
    __classPrivateFieldSet3(fhevmExecutor, _FHEVMExecutor_hcuLimitAddress, properties?.hcuLimitAddress, "f");
    __classPrivateFieldSet3(fhevmExecutor, _FHEVMExecutor_inputVerifierAddress, properties?.inputVerifierAddress, "f");
    __classPrivateFieldSet3(fhevmExecutor, _FHEVMExecutor_version, properties?.version, "f");
...
var InputVerifier = class _InputVerifier extends FhevmCoprocessorContractWrapper {
  ...
  static async create(runner, inputVerifierContractAddress, abi, properties) {
    ...
    __classPrivateFieldSet5(inputVerifier, _InputVerifier_eip712Domain, properties?.eip712Domain, "f");
    __classPrivateFieldSet5(inputVerifier, _InputVerifier_signersAddresses, properties?.signersAddresses, "f");
    __classPrivateFieldSet5(inputVerifier, _InputVerifier_threshold, properties?.threshold, "f");
...
var FhevmContractsRepository = class _FhevmContractsRepository {
  ...
  getFhevmInstanceConfig(params) {
    ...
    assertFhevm(__classPrivateFieldGet9(this, _FhevmContractsRepository_kmsVerifier, "f") !== void 0, "FhevmContractsRepository is not initialized");
    assertFhevm(__classPrivateFieldGet9(this, _FhevmContractsRepository_inputVerifier, "f") !== void 0, "FhevmContractsRepository is not initialized");
    const decryptionOracleAddress = __classPrivateFieldGet9(this, _FhevmContractsRepository_zamaFheDecryptionOracle, "f")?.address;
    return {
      aclContractAddress: __classPrivateFieldGet9(this, _FhevmContractsRepository_acl, "f").address,
      fhevmExecutorContractAddress: __classPrivateFieldGet9(this, _FhevmContractsRepository_fhevmExecutor, "f")?.address,
...
// node_modules/@fhevm/mock-utils/_esm/relayer-sdk/types.js
...
async function _resolveUserDecryptOptions(instance, options) {
  ...
  const durationDays = options?.validity?.durationDays || constants_default.DEFAULT_DURATION_DAYS;
