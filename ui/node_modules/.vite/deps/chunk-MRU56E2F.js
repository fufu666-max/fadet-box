...
var ICONS = {
  add: async () => (await import("./add-U7SPCQ7J.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-DHIENIQ7.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-NK7DZGGU.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-YRM6GO25.js")).appStoreSvg,
  apple: async () => (await import("./apple-VGXOMXWE.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-ODBTSI6H.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-T2OPYHK6.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-QW5KFHMW.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-6TN36GAO.js")).arrowTopSvg,
  bank: async () => (await import("./bank-VS7NWTR6.js")).bankSvg,
  browser: async () => (await import("./browser-OVIHT7QH.js")).browserSvg,
  card: async () => (await import("./card-EVLCTJXV.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-4DKZGKQP.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-64FUFNZZ.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-M62YI6MS.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-5XTLDDK3.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-WHQUTHSB.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-BVTPDWZL.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-GUZHOVQQ.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-ZMGIRYUS.js")).clockSvg,
  close: async () => (await import("./close-HW4YIUWU.js")).closeSvg,
  compass: async () => (await import("./compass-6ED5H4SF.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-2XYVV52X.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-JFZG3KQN.js")).copySvg,
  cursor: async () => (await import("./cursor-5F5FYBR2.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-PNPRGCCQ.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-EMUB6PBD.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-U436W24K.js")).disconnectSvg,
  discord: async () => (await import("./discord-WSU2IWQP.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-3YSIJBAF.js")).etherscanSvg,
  extension: async () => (await import("./extension-XVKTLNLT.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-2WZO3YF6.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-IMCD2WBI.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-ZK2FC5TM.js")).farcasterSvg,
  filters: async () => (await import("./filters-DXHL2LZT.js")).filtersSvg,
  github: async () => (await import("./github-I463J3P2.js")).githubSvg,
  google: async () => (await import("./google-IZIEPX4F.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-VTI3JLFJ.js")).helpCircleSvg,
  image: async () => (await import("./image-F2R6BFU3.js")).imageSvg,
  id: async () => (await import("./id-ZMB6UOEU.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-ORZP47IA.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-CLEGIAC7.js")).lightbulbSvg,
  mail: async () => (await import("./mail-C7XRP7HJ.js")).mailSvg,
  mobile: async () => (await import("./mobile-FMCNWLJ3.js")).mobileSvg,
  more: async () => (await import("./more-NTLNFTW2.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-TG5MM26E.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-AVNVTW7Q.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-IQ7T2IP2.js")).offSvg,
  playStore: async () => (await import("./play-store-W6B2ODTA.js")).playStoreSvg,
  plus: async () => (await import("./plus-HSP5KO7Q.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-7U7NKEQL.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-33JAOAW4.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-YPDDPFVO.js")).refreshSvg,
  search: async () => (await import("./search-IP2R27T2.js")).searchSvg,
  send: async () => (await import("./send-X2WU5ZZD.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-KYCWRVML.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-SBYTCJEX.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-C2TVFJ2W.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-YTVNPDNR.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-C2KH4AVI.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-K7PYP5E6.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-AFYFE5NH.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-TGSMIKVP.js")).twitchSvg,
  twitter: async () => (await import("./x-TZNZFQAV.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-HSNBQ7JU.js")).twitterIconSvg,
  verify: async () => (await import("./verify-5HEKQFHN.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-KH3X6JKO.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-FCGXS3HF.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-5BQYHXYG.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-5BQYHXYG.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-5BQYHXYG.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-QEAOU2EG.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-2HHUWD6D.js")).warningCircleSvg,
  x: async () => (await import("./x-TZNZFQAV.js")).xSvg,
  info: async () => (await import("./info-K6VSN6KS.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-7KKMORLC.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-5DFPA3DR.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MRU56E2F.js.map
