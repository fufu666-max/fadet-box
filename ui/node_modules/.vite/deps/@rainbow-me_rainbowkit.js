...
import {
  en_US_default
} from "./chunk-X6CC3U3E.js";
import "./chunk-YNNZR3BJ.js";
import "./chunk-CZRYIB2X.js";
import "./chunk-SRBIO35Z.js";
import "./chunk-OZULDQUG.js";
import {
  require_browser,
  require_fast_safe_stringify,
  require_semver
} from "./chunk-KUILKNV3.js";
import {
  ...
  useSignMessage,
  useSwitchChain
} from "./chunk-GX7JUG3E.js";
import "./chunk-7VRYR6R7.js";
import "./chunk-Q57RPHDP.js";
import {
  Field,
  FpInvertBatch,
  FpLegendre,
...
import "./chunk-YIY2QXFF.js";
import "./chunk-254F2JS3.js";
import {
  arbitrum,
  arbitrumSepolia,
  base,
  ...
  polygonAmoy,
  sepolia
} from "./chunk-WUAPWYC6.js";
import "./chunk-SMSNANLU.js";
import {
...
import "./chunk-2B4D5KWP.js";
import "./chunk-V6JCQE3K.js";
import {
  useQuery
} from "./chunk-OS35KTBO.js";
import {
  clsx_default
} from "./chunk-E4FBQG46.js";
import {
  keccak_256
} from "./chunk-N4FUJJYF.js";
import {
  RemoveScrollBar,
  createSidecarMedium,
  exportSidecar,
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-E63SLM7I.js";
import {
  __assign,
  __rest,
  __spreadArray,
  init_tslib_es6
} from "./chunk-ZKX7OVY2.js";
import {
  require_react_dom
} from "./chunk-YAZM2FKX.js";
import {
  require_jsx_runtime
...
var bls12_381 = bls({
  ...
  G2: {
    ...
    fromBytes: (bytes) => {
      ...
      const L = Fp.BYTES;
      const slc = (b, from7, to) => bytesToNumberBE(b.slice(from7, to));
...
// node_modules/@rainbow-me/rainbowkit/node_modules/react-remove-scroll/dist/es2015/index.js
...
// node_modules/cuer/_dist/index.js
...
function encode2(ver, ecc, data, type2) {
  let encoded = "";
...
(function(Cuer2) {
  Cuer2.Context = React4.createContext(null);
  function Root(props) {
    const { children, size: size4 = "100%", value, version: version2, errorCorrection, ...rest } = props;
    const hasArena = React4.useMemo(() => (React4.Children.map(children, (child) => {
    ...
    const context = React4.useMemo(() => ({ arenaSize, cellSize, edgeSize, qrcode, finderSize }), [arenaSize, edgeSize, qrcode, finderSize]);
  ...
  function Finder(props) {
    ...
    const { cellSize, edgeSize, finderSize } = React4.useContext(Cuer2.Context);
  ...
  function Cells(props) {
    ...
    const { arenaSize, cellSize, qrcode } = React4.useContext(Cuer2.Context);
    const { edgeLength, finderLength } = qrcode;
    const path2 = React4.useMemo(() => {
      let path3 = "";
  ...
  function Arena(props) {
    ...
    const { arenaSize, cellSize, edgeSize } = React4.useContext(Cuer2.Context);
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-VEQ3U6W5.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-AXF2HYKQ.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-VXYJ6TCR.js");
...
// node_modules/@metamask/utils/dist/index.mjs
...
// node_modules/@metamask/superstruct/dist/index.mjs
...
// node_modules/@metamask/utils/dist/encryption-types.mjs
...
// node_modules/@metamask/utils/dist/keyring.mjs
...
// node_modules/@metamask/utils/dist/opaque.mjs
...
// node_modules/@metamask/utils/dist/transaction-types.mjs
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-GKSSBQ6T.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
...
// node_modules/@wagmi/connectors/node_modules/porto/dist/internal/index.js
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-TDCC6OPF.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-VGKRJDS6.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-3A72EPES.js");
...
var AuthenticationContext = (0, import_react2.createContext)(
  null
);
function RainbowKitAuthenticationProvider({
  ...
  const [currentConnectorUid, setCurrentConnectorUid] = (0, import_react2.useState)();
  useAccountEffect({
    onDisconnect: () => {
      adapter.signOut();
...
function useAuthenticationAdapter() {
  const { adapter } = (0, import_react2.useContext)(AuthenticationContext) ?? {};
  if (!adapter) {
...
function useAuthenticationStatus() {
  const contextValue = (0, import_react2.useContext)(AuthenticationContext);
...
function AsyncImage({
  ...
  const [isRemoteImageLoaded, setRemoteImageLoaded] = (0, import_react3.useReducer)(
    () => true,
    false
  );
  return import_react3.default.createElement(
    ...
    borderColor ? import_react3.default.createElement(
      Box,
      {
...
var useRandomId = (prefix) => (0, import_react7.useMemo)(
...
var SpinnerIcon = ({
  ...
  return import_react7.default.createElement(
    ...
    import_react7.default.createElement("title", null, "Loading"),
    import_react7.default.createElement("clipPath", { id }, import_react7.default.createElement("path", { d: "M10.5 3C6.35786 3 3 6.35786 3 10.5C3 14.6421 6.35786 18 10.5 18C11.3284 18 12 18.6716 12 19.5C12 20.3284 11.3284 21 10.5 21C4.70101 21 0 16.299 0 10.5C0 4.70101 4.70101 0 10.5 0C16.299 0 21 4.70101 21 10.5C21 11.3284 20.3284 12 19.5 12C18.6716 12 18 11.3284 18 10.5C18 6.35786 14.6421 3 10.5 3Z" })),
    import_react7.default.createElement(
      ...
      import_react7.default.createElement("div", { className: SpinnerIconPathClassName })
    )
  );
};
var colors = [
...
var EmojiAvatar = ({ address, ensImage, size: size4 }) => {
  ...
  const { color: backgroundColor, emoji } = (0, import_react9.useMemo)(
    () => emojiAvatarForAddress(address),
    [address]
  );
  return ensImage ? loaded ? import_react9.default.createElement(
    Box,
    {
    ...
    import_react9.default.createElement(SpinnerIcon, null)
  ) : import_react9.default.createElement(
    Box,
    {
      alignItems: "center",
...
var AvatarContext = (0, import_react8.createContext)(defaultAvatar);
function Avatar({ address, imageUrl, loading, size: size4 }) {
  const AvatarComponent = (0, import_react6.useContext)(AvatarContext);
  return import_react6.default.createElement(
    ...
    import_react6.default.createElement(
      ...
      import_react6.default.createElement(AvatarComponent, { address, ensImage: imageUrl, size: size4 })
    ),
    loading && import_react6.default.createElement(
      Box,
      {
        color: "accentColor",
        display: "flex",
      ...
      import_react6.default.createElement(SpinnerIcon, { height: "100%", width: "100%" })
    )
  );
}
var DropdownIcon = () => import_react10.default.createElement("svg", { fill: "none", height: "7", width: "14", xmlns: "http://www.w3.org/2000/svg" }, import_react10.default.createElement("title", null, "Dropdown"), import_react10.default.createElement(
  "path",
  {
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-CTNWGWSS-6RNDLI7L.js")).default;
    case "de":
    case "de-DE":
      return (await import("./de_DE-P43L3PR7-B6PQ7RO7.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-KAK2ZBDO-4WULDGLL.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-JBX5FS3Q-QXSLUT44.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-CM2EDAQC-SAQBDSXZ.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-GYVCUYRD-ZIXLSWAH.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-7ZWSMOOE-OVHICNDN.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-CGMP6VLZ-IRHZ3QXC.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-YCZDTF7X-42RAP4VQ.js")).default;
    case "ms":
    case "ms-MY":
      return (await import("./ms_MY-5LHAYMS7-G2X34IOY.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-3JTS4PSK-5YPEHAZ3.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-6J6XERHI-D3V2GNSZ.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-STXOD4CR-3CADMWVL.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-P7QAUUZU-YFD6CJ2Z.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-JTTBGJGQ-KRI6OJUL.js")).default;
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-5XUUAVWW-EYEYJ4IO.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-RGMLPFEP-FGRWRGHO.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-YM3T6EI5-33CAX2KB.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-HAEH6VE5-XSSYY6HI.js")).default;
    default:
      return (await import("./en_US-KAK2ZBDO-4WULDGLL.js")).default;
  }
};
...
var I18nContext = (0, import_react11.createContext)({ i18n });
var I18nProvider = ({ children, locale }) => {
  const [updateCount, setUpdateCount] = (0, import_react11.useState)(0);
  const browserLocale = (0, import_react11.useMemo)(
  ...
  const memoizedValue = (0, import_react11.useMemo)(() => {
    const t = (key, options) => i18n.t(key, options);
    return { t, i18n };
  }, [updateCount]);
  return import_react11.default.createElement(I18nContext.Provider, { value: memoizedValue }, children);
};
...
var apeChainIcon = {
  ...
  iconUrl: async () => (await import("./apechain-SX5YFU6N-A6BVHTYJ.js")).default
};
var arbitrumIcon = {
  iconBackground: "#96bedc",
  iconUrl: async () => (await import("./arbitrum-WURIBY6W-QGQY4263.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-KOMJD3XY-HD3UJ2QZ.js")).default
};
var baseIcon = {
  iconBackground: "#0052ff",
  iconUrl: async () => (await import("./base-OAXLRA4F-JB4W6VN5.js")).default
};
var berachainIcon = {
  iconBackground: "#814625",
  iconUrl: async () => (await import("./berachain-NJECWIVC-HTZ6MZLI.js")).default
};
var blastIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./blast-V555OVXZ-4XIYTFAP.js")).default
};
var bscIcon = {
  iconBackground: "#ebac0e",
  iconUrl: async () => (await import("./bsc-N647EYR2-GMKA2QYJ.js")).default
};
var celoIcon = {
  iconBackground: "#FCFF52",
  iconUrl: async () => (await import("./celo-GEP4TUHG-UPZSN4JG.js")).default
};
var cronosIcon = {
  iconBackground: "#002D74",
  iconUrl: async () => (await import("./cronos-HJPAQTAE-YYG5QIYA.js")).default
};
var degenIcon = {
  iconBackground: "#A36EFD",
  iconUrl: async () => (await import("./degen-FQQ4XGHB-RNPADHZ6.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-RGGVA4PY-3NIMAITN.js")).default
};
var flowIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./flow-5FQJFCTK-G2C3UZVP.js")).default
};
var gnosisIcon = {
  iconBackground: "#04795c",
  iconUrl: async () => (await import("./gnosis-37ZC4RBL-5FVU5Q22.js")).default
};
var gravityIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./gravity-J5YQHTYH-A4XLRMDY.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-TX56IT5N-MUJB23UO.js")).default
};
var hyperevmIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./hyperevm-VKPAA4SA-ECOS5H2D.js")).default
};
var inkIcon = {
  iconBackground: "#7132F5",
  iconUrl: async () => (await import("./ink-FZMYZWHG-PVFXQKMC.js")).default
};
var kaiaIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./kaia-65D2U3PU-B7QFJOX6.js")).default
};
var lineaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./linea-QRMVQ5DY-B2I54BY3.js")).default
};
var mantaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./manta-SI27YFEJ-6QJXJHD7.js")).default
};
var mantleIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./mantle-CKIUT334-TUX3UJAH.js")).default
};
var monadTestnetIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./monad-4KWC6TSS-VGKVUG2F.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-HAF2GUT7-MX5UG5ZX.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-WW6ZI7PM-5CC42VVB.js")).default
};
var roninIcon = {
  iconBackground: "#1273EA",
  iconUrl: async () => (await import("./ronin-EMCPYXZT-REXQXSKM.js")).default
};
var sankoIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./sanko-RHQYXGM5-DWDXMG7V.js")).default
};
var superpositionIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./superposition-HG6MMR2Y-KLHHKABP.js")).default
};
var scrollIcon = {
  iconBackground: "#FFEEDA",
  iconUrl: async () => (await import("./scroll-5OBGQVOV-6S7RU2X3.js")).default
};
var unichainIcon = {
  iconBackground: "#F50DB4",
  iconUrl: async () => (await import("./unichain-C5BWO2ZY-UIXDOIOP.js")).default
};
var xdcIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./xdc-KJ3TDBYO-E27DZZYO.js")).default
};
var zetachainIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zetachain-TLDS5IPW-CPOH4FYO.js")).default
};
var zkSyncIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./zksync-DH7HK5U4-Y7MPEJV7.js")).default
};
var zoraIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zora-FYL5H3IO-7WBC5JW6.js")).default
};
...
var RainbowKitChainContext = (0, import_react12.createContext)({
  chains: []
});
function RainbowKitChainProvider({
  ...
  return import_react12.default.createElement(
    ...
    {
      value: (0, import_react12.useMemo)(
        () => ({
...
var useRainbowKitChains = () => (0, import_react12.useContext)(RainbowKitChainContext).chains;
var useInitialChainId = () => (0, import_react12.useContext)(RainbowKitChainContext).initialChainId;
...
var ShowBalanceContext = (0, import_react13.createContext)({
  showBalance: void 0,
  setShowBalance: () => {
  }
});
function ShowBalanceProvider({ children }) {
  const [showBalance, setShowBalance] = (0, import_react13.useState)();
  return import_react13.default.createElement(ShowBalanceContext.Provider, { value: { showBalance, setShowBalance } }, children);
}
var useShowBalance = () => (0, import_react13.useContext)(ShowBalanceContext);
function useIsMounted() {
  const [isMounted, setIsMounted] = (0, import_react15.useState)(false);
  ...
  return (0, import_react15.useCallback)(() => isMounted, [isMounted]);
}
...
var storeSingleton;
var TransactionStoreContext = import_react17.default.createContext(
  null
);
function TransactionStoreProvider({
  ...
  const [store] = import_react17.default.useState(
    () => storeSingleton ?? (storeSingleton = createTransactionStore({ provider }))
  );
  const onTransactionStatus = import_react17.default.useCallback(
    (txStatus) => {
  ...
  return import_react17.default.createElement(TransactionStoreContext.Provider, { value: store }, children);
}
function useTransactionStore() {
  const store = import_react17.default.useContext(TransactionStoreContext);
  if (!store) {
...
var AppContext = (0, import_react22.createContext)(defaultAppInfo);
var CoolModeContext = (0, import_react23.createContext)(false);
...
var WalletButtonContext = (0, import_react26.createContext)({
  connector: null,
  setConnector: () => {
  }
});
function WalletButtonProvider({ children }) {
  const [connector, setConnector] = (0, import_react26.useState)(null);
  return import_react26.default.createElement(
    WalletButtonContext.Provider,
    {
      value: (0, import_react26.useMemo)(
        () => ({
          connector,
          setConnector
        }),
...
var ModalSizeContext = (0, import_react24.createContext)(
...
function ModalSizeProvider({
  ...
  const { connector } = (0, import_react24.useContext)(WalletButtonContext);
...
var src = async () => (await import("./assets-Q6ZU7ZJ5-3QMSDVIQ.js")).default;
var preloadAssetsIcon = () => loadImages(src);
var AssetsIcon = () => import_react30.default.createElement(
  AsyncImage,
  {
    background: "#d0d5de",
    borderRadius: "10",
...
var src2 = async () => (await import("./login-UP3DZBGS-3JA4PN4D.js")).default;
var preloadLoginIcon = () => loadImages(src2);
var LoginIcon = () => import_react31.default.createElement(
  AsyncImage,
  {
    background: "#d0d5de",
    borderRadius: "10",
...
var Text = import_react34.default.forwardRef(
  ({
    as = "div",
    children,
    className,
...
var CloseIcon = () => {
  return isMobile() ? import_react36.default.createElement(
    "svg",
    {
      "aria-hidden": true,
      fill: "none",
    ...
    import_react36.default.createElement("title", null, "Close"),
...
var CloseButton = ({
  ...
  return import_react35.default.createElement(
    ...
    import_react35.default.createElement(CloseIcon, null)
  );
};
var signInIcon = async () => (await import("./sign-A7IJEUT5-EAYMVVE7.js")).default;
function SignIn({
  onClose,
  onCloseModal
}) {
  const { i18n: i18n2 } = (0, import_react32.useContext)(I18nContext);
  const [{ status, ...state }, setState] = import_react32.default.useState({ status: "idle" });
  const authAdapter = useAuthenticationAdapter();
  const getNonce = (0, import_react32.useCallback)(async () => {
    try {
  ...
  const onceRef = (0, import_react32.useRef)(false);
  ...
  return import_react32.default.createElement(Box, { position: "relative" }, import_react32.default.createElement(
    Box,
    {
      display: "flex",
      paddingRight: "16",
    ...
    import_react32.default.createElement(CloseButton, { onClose })
    ...
    import_react32.default.createElement(
      ...
      import_react32.default.createElement(
        ...
        import_react32.default.createElement(AsyncImage, { height: 40, src: signInIcon, width: 40 }),
        import_react32.default.createElement(
          Text,
          {
            color: "modalText",
      ...
      import_react32.default.createElement(
        ...
        status === "idle" && state.errorMessage ? import_react32.default.createElement(
          Text,
          {
            color: "error",
            size: mobile ? "16" : "14",
    ...
    import_react32.default.createElement(
      ...
      mobile ? import_react32.default.createElement(
        ActionButton,
        {
          label: "Cancel",
          onClick: onClose,
...
function usePreloadImages() {
  ...
  const preloadImages = (0, import_react29.useCallback)(() => {
    loadImages(
...
function RainbowKitProvider({
  ...
  return import_react21.default.createElement(RainbowKitChainProvider, { initialChain }, import_react21.default.createElement(WalletButtonProvider, null, import_react21.default.createElement(I18nProvider, { locale }, import_react21.default.createElement(CoolModeContext.Provider, { value: coolMode }, import_react21.default.createElement(ModalSizeProvider, { modalSize }, import_react21.default.createElement(
    ShowRecentTransactionsContext.Provider,
    {
      value: showRecentTransactions
    },
    import_react21.default.createElement(TransactionStoreProvider, null, import_react21.default.createElement(AvatarContext.Provider, { value: avatarContext }, import_react21.default.createElement(AppContext.Provider, { value: appContext }, import_react21.default.createElement(ThemeIdContext.Provider, { value: id }, import_react21.default.createElement(ShowBalanceProvider, null, import_react21.default.createElement(ModalProvider, null, theme ? import_react21.default.createElement("div", { ...createThemeRootProps(id) }, import_react21.default.createElement(
      "style",
      {
...
function FocusTrap(props) {
  ...
  return import_react37.default.createElement(import_react37.default.Fragment, null, import_react37.default.createElement(
    "div",
    {
      onFocus: (0, import_react38.useCallback)(
...
function Dialog({ children, onClose, open, titleId }) {
  ...
  const mobile = isMobile();
  return import_react20.default.createElement(import_react20.default.Fragment, null, open ? (0, import_react_dom.createPortal)(
    import_react20.default.createElement(Combination_default, { enabled: bodyScrollable }, import_react20.default.createElement(Box, { ...themeRootProps }, import_react20.default.createElement(
      Box,
      {
        ...themeRootProps,
...
function DialogContent({
  ...
  const mobile = isMobile();
  const modalSize = (0, import_react39.useContext)(ModalSizeContext);
  const compactModeEnabled = modalSize === ModalSizeOptions.COMPACT;
  return import_react39.default.createElement(Box, { marginTop }, import_react39.default.createElement(
    Box,
    {
      className: [
    ...
    import_react39.default.createElement(Box, { padding, paddingBottom: paddingBottom ?? padding }, children)
  ));
}
var units = ["k", "m", "b", "t"];
...
var CopiedIcon = () => import_react41.default.createElement(
  "svg",
  {
    fill: "none",
    height: "13",
  ...
  import_react41.default.createElement("title", null, "Copied"),
...
var CopyIcon = () => import_react42.default.createElement(
  "svg",
  {
    fill: "none",
    height: "16",
  ...
  import_react42.default.createElement("title", null, "Copy"),
...
var DisconnectIcon = () => import_react43.default.createElement(
  "svg",
  {
    fill: "none",
    height: "16",
  ...
  import_react43.default.createElement("title", null, "Disconnect"),
...
var ExternalLinkIcon = () => import_react46.default.createElement(
  "svg",
  {
    fill: "none",
    height: "19",
  ...
  import_react46.default.createElement("title", null, "Link"),
...
var CancelIcon = () => import_react48.default.createElement(
  "svg",
  {
    fill: "none",
    height: "19",
  ...
  import_react48.default.createElement("title", null, "Cancel"),
...
var SuccessIcon = () => import_react49.default.createElement(
  "svg",
  {
    fill: "none",
    height: "20",
  ...
  import_react49.default.createElement("title", null, "Success"),
...
function TxItem({ tx }) {
  ...
  return import_react47.default.createElement(import_react47.default.Fragment, null, import_react47.default.createElement(
    ...
    import_react47.default.createElement(
      ...
      import_react47.default.createElement(Box, { color }, import_react47.default.createElement(Icon, null)),
      import_react47.default.createElement(Box, { display: "flex", flexDirection: "column", gap: mobile ? "3" : "1" }, import_react47.default.createElement(Box, null, import_react47.default.createElement(
        Text,
        {
          color: "modalText",
          font: "body",
        ...
        tx?.description
      )), import_react47.default.createElement(Box, null, import_react47.default.createElement(
        Text,
        {
    ...
    explorerLink && import_react47.default.createElement(Box, { alignItems: "center", color: "modalTextDim", display: "flex" }, import_react47.default.createElement(ExternalLinkIcon, null))
  ));
}
...
function TxList({ address }) {
  ...
  const mobile = isMobile();
  const { appName } = (0, import_react44.useContext)(AppContext);
  const { i18n: i18n2 } = (0, import_react44.useContext)(I18nContext);
  return import_react44.default.createElement(import_react44.default.Fragment, null, import_react44.default.createElement(
    ...
    hasTransactions && import_react44.default.createElement(
      Box,
      {
      ...
      import_react44.default.createElement(Box, { display: "flex", justifyContent: "space-between" }, import_react44.default.createElement(
        Text,
        {
          color: "modalTextSecondary",
          size: mobile ? "16" : "14",
    ...
    import_react44.default.createElement(Box, { display: "flex", flexDirection: "column", gap: "4" }, hasTransactions ? visibleTxs.map((tx) => import_react44.default.createElement(TxItem, { key: tx.hash, tx })) : import_react44.default.createElement(import_react44.default.Fragment, null, import_react44.default.createElement(Box, { padding: mobile ? "12" : "8" }, import_react44.default.createElement(
      Text,
      {
        color: "modalTextDim",
        size: mobile ? "16" : "14",
    ...
    )), mobile && import_react44.default.createElement(
      Box,
      {
  ...
  ), explorerLink && import_react44.default.createElement(Box, { paddingBottom: "18", paddingX: mobile ? "8" : "18" }, import_react44.default.createElement(
    Box,
    {
      alignItems: "center",
      as: "a",
...
function ProfileDetailsAction({
  ...
  return import_react50.default.createElement(
    ...
    import_react50.default.createElement(
      ...
      import_react50.default.createElement(Box, { color: "modalText", height: "max" }, icon),
      import_react50.default.createElement(Box, null, import_react50.default.createElement(Text, { color: "modalText", size: mobile ? "12" : "13", weight: "semibold" }, label))
    )
  );
}
function ProfileDetails({
  ...
  const showRecentTransactions = (0, import_react40.useContext)(ShowRecentTransactionsContext);
  const [copiedAddress, setCopiedAddress] = (0, import_react40.useState)(false);
  const copyAddressAction = (0, import_react40.useCallback)(() => {
    if (address) {
  ...
  const mobile = isMobile();
  const { i18n: i18n2 } = (0, import_react40.useContext)(I18nContext);
  return import_react40.default.createElement(import_react40.default.Fragment, null, import_react40.default.createElement(Box, { display: "flex", flexDirection: "column" }, import_react40.default.createElement(Box, { background: "profileForeground", padding: "16" }, import_react40.default.createElement(
    Box,
    {
      alignItems: "center",
      display: "flex",
    ...
    import_react40.default.createElement(
      ...
      import_react40.default.createElement(CloseButton, { onClose })
    ),
    " ",
    import_react40.default.createElement(Box, { marginTop: mobile ? "24" : "0" }, import_react40.default.createElement(
      Avatar,
      {
        address,
        imageUrl: ensAvatar,
    ...
    import_react40.default.createElement(
      ...
      import_react40.default.createElement(Box, { textAlign: "center" }, import_react40.default.createElement(
        Text,
        {
          as: "h1",
          color: "modalText",
      ...
      !!balance && import_react40.default.createElement(Box, { textAlign: "center" }, import_react40.default.createElement(
        Text,
        {
          as: "h1",
          color: "modalTextSecondary",
    ...
    import_react40.default.createElement(
      ProfileDetailsAction,
      {
        ...
        icon: copiedAddress ? import_react40.default.createElement(CopiedIcon, null) : import_react40.default.createElement(CopyIcon, null),
    ...
    import_react40.default.createElement(
      ...
      {
        action: onDisconnect,
        icon: import_react40.default.createElement(DisconnectIcon, null),
        label: i18n2.t("profile.disconnect.label"),
        testId: "disconnect-button"
      }
    )
  )), showRecentTransactions && import_react40.default.createElement(import_react40.default.Fragment, null, import_react40.default.createElement(Box, { background: "generalBorder", height: "1", marginTop: "-1" }), import_react40.default.createElement(Box, null, import_react40.default.createElement(TxList, { address })))));
}
function AccountModal({ onClose, open }) {
  ...
  return import_react19.default.createElement(import_react19.default.Fragment, null, address && import_react19.default.createElement(Dialog, { onClose, open, titleId }, import_react19.default.createElement(DialogContent, { bottomSheetOnMobile: true, padding: "0" }, import_react19.default.createElement(
    ProfileDetails,
    {
      address,
      ensAvatar,
...
var DisconnectSqIcon = ({ size: size4 }) => import_react52.default.createElement(
  "svg",
  {
    fill: "none",
    height: size4,
  ...
  import_react52.default.createElement("title", null, "Disconnect"),
...
var MenuButton = import_react53.default.forwardRef(
  ({
    children,
...
var Chain = ({
  ...
  return import_react54.default.createElement(import_react54.Fragment, null, import_react54.default.createElement(
    MenuButton,
    {
    ...
    import_react54.default.createElement(Box, { fontFamily: "body", fontSize: "16", fontWeight: "bold" }, import_react54.default.createElement(
      Box,
      {
        alignItems: "center",
        display: "flex",
      ...
      import_react54.default.createElement(
        ...
        src7 && import_react54.default.createElement(Box, { height: "full", marginRight: "8" }, import_react54.default.createElement(
          AsyncImage,
          {
            alt: name,
        ...
        import_react54.default.createElement("div", null, name ?? name)
      ),
      isCurrentChain && import_react54.default.createElement(
        Box,
        {
          alignItems: "center",
          display: "flex",
        ...
        import_react54.default.createElement(Text, { color: "accentColorForeground", size: "14", weight: "medium" }, i18n2.t("chains.connected")),
        import_react54.default.createElement(
          Box,
          {
      ...
      isLoading && import_react54.default.createElement(
        Box,
        {
          alignItems: "center",
          display: "flex",
        ...
        import_react54.default.createElement(Text, { color: "modalText", size: "14", weight: "medium" }, i18n2.t("chains.confirm")),
        import_react54.default.createElement(
          Box,
          {
            background: "standby",
  ...
  ), mobile && idx < rainbowkitChains.length - 1 && import_react54.default.createElement(Box, { background: "generalBorderDim", height: "1", marginX: "8" }));
};
...
function ChainModal({ onClose, open }) {
  ...
  const { chains } = useConfig();
  const [pendingChainId, setPendingChainId] = (0, import_react51.useState)(null);
  ...
  const { i18n: i18n2 } = (0, import_react51.useContext)(I18nContext);
  const { disconnect } = useDisconnect();
  ...
  return import_react51.default.createElement(Dialog, { onClose, open, titleId }, import_react51.default.createElement(DialogContent, { bottomSheetOnMobile: true, paddingBottom: "0" }, import_react51.default.createElement(Box, { display: "flex", flexDirection: "column", gap: "14" }, import_react51.default.createElement(
    Box,
    {
      display: "flex",
      flexDirection: "row",
    ...
    mobile && import_react51.default.createElement(Box, { width: "30" }),
    import_react51.default.createElement(Box, { paddingBottom: "0", paddingLeft: "8", paddingTop: "4" }, import_react51.default.createElement(
      Text,
      {
        as: "h1",
        color: "modalText",
    ...
    import_react51.default.createElement(CloseButton, { onClose })
  ), !isCurrentChainSupported && import_react51.default.createElement(Box, { marginX: "8", textAlign: mobile ? "center" : "left" }, import_react51.default.createElement(Text, { color: "modalTextSecondary", size: "14", weight: "medium" }, i18n2.t("chains.wrong_network"))), import_react51.default.createElement(
    Box,
    {
    ...
    !isCurrentChainSupported && import_react51.default.createElement(import_react51.default.Fragment, null, import_react51.default.createElement(Box, { background: "generalBorderDim", height: "1", marginX: "8" }), import_react51.default.createElement(
      MenuButton,
      {
        onClick: () => disconnect(),
        ...
        import_react51.default.createElement(
          ...
          import_react51.default.createElement(
            ...
            import_react51.default.createElement(
              ...
              import_react51.default.createElement(DisconnectSqIcon, { size: Number(chainIconSize) })
            ),
            import_react51.default.createElement("div", null, i18n2.t("chains.disconnect"))
          )
        )
      )
    ))
...
var DisclaimerText = ({ children }) => {
  return import_react60.default.createElement(Text, { color: "modalTextSecondary", size: "12", weight: "medium" }, children);
};
function ConnectModalIntro({
  ...
  return import_react58.default.createElement(import_react58.default.Fragment, null, import_react58.default.createElement(
    Box,
    {
      alignItems: "center",
      color: "accentColor",
    ...
    import_react58.default.createElement(Box, { marginBottom: "10" }, !compactModeEnabled && import_react58.default.createElement(Text, { color: "modalText", size: "18", weight: "heavy" }, i18n2.t("intro.title"))),
    import_react58.default.createElement(
      ...
      import_react58.default.createElement(Box, { alignItems: "center", display: "flex", flexDirection: "row", gap: "16" }, import_react58.default.createElement(Box, { borderRadius: "6", height: "48", minWidth: "48", width: "48" }, import_react58.default.createElement(AssetsIcon, null)), import_react58.default.createElement(Box, { display: "flex", flexDirection: "column", gap: "4" }, import_react58.default.createElement(Text, { color: "modalText", size: "14", weight: "bold" }, i18n2.t("intro.digital_asset.title")), import_react58.default.createElement(Text, { color: "modalTextSecondary", size: "14", weight: "medium" }, i18n2.t("intro.digital_asset.description")))),
      import_react58.default.createElement(Box, { alignItems: "center", display: "flex", flexDirection: "row", gap: "16" }, import_react58.default.createElement(Box, { borderRadius: "6", height: "48", minWidth: "48", width: "48" }, import_react58.default.createElement(LoginIcon, null)), import_react58.default.createElement(Box, { display: "flex", flexDirection: "column", gap: "4" }, import_react58.default.createElement(Text, { color: "modalText", size: "14", weight: "bold" }, i18n2.t("intro.login.title")), import_react58.default.createElement(Text, { color: "modalTextSecondary", size: "14", weight: "medium" }, i18n2.t("intro.login.description"))))
    ),
    import_react58.default.createElement(
      Box,
      {
      ...
      import_react58.default.createElement(ActionButton, { label: i18n2.t("intro.get.label"), onClick: getWallet }),
      import_react58.default.createElement(
        Box,
        {
          as: "a",
        ...
        import_react58.default.createElement(Text, { color: "accentColor", size: "14", weight: "bold" }, i18n2.t("intro.learn_more.label"))
      )
    ),
    Disclaimer && !compactModeEnabled && import_react58.default.createElement(Box, { marginBottom: "8", marginTop: "12", textAlign: "center" }, import_react58.default.createElement(Disclaimer, { Link: DisclaimerLink, Text: DisclaimerText }))
  ));
}
var BackIcon = () => import_react61.default.createElement(
  "svg",
  {
    fill: "none",
    height: "17",
  ...
  import_react61.default.createElement("title", null, "Back"),
...
var InfoIcon = () => import_react63.default.createElement(
  "svg",
  {
    fill: "none",
    height: "12",
  ...
  import_react63.default.createElement("title", null, "Info"),
...
var ModalSelection = ({
  ...
  const [isMouseOver, setIsMouseOver] = import_react64.default.useState(false);
  const { i18n: i18n2 } = import_react64.default.useContext(I18nContext);
  return import_react64.default.createElement(
    ...
    import_react64.default.createElement(
      ...
      import_react64.default.createElement(
        ...
        import_react64.default.createElement(Box, { alignItems: "center", display: "flex", flexDirection: "row", gap: "12" }, import_react64.default.createElement(
          AsyncImage,
          {
            background: iconBackground,
        ...
        ), import_react64.default.createElement(Box, null, import_react64.default.createElement(
          Box,
          {
          ...
          name
        ), recent && import_react64.default.createElement(
          Text,
          {
...
var src3 = async () => (await import("./connect-UA7M4XW6-O7KY3NJK.js")).default;
var preloadConnectIcon = () => loadImages(src3);
var ConnectIcon = () => import_react67.default.createElement(
  AsyncImage,
  {
    background: "#515a70",
...
var src4 = async () => (await import("./create-FASO7PVG-BZJHSDNP.js")).default;
var preloadCreateIcon = () => loadImages(src4);
var CreateIcon = () => import_react68.default.createElement(
  AsyncImage,
  {
    background: "#e3a5e8",
    borderColor: "generalBorder",
...
var src5 = async () => (await import("./refresh-S4T5V5GX-EOWRRVFV.js")).default;
var preloadRefreshIcon = () => loadImages(src5);
var RefreshIcon = () => import_react69.default.createElement(
  AsyncImage,
  {
    background: "#515a70",
    borderColor: "generalBorder",
...
var src6 = async () => (await import("./scan-4UYSQ56Q-JGXNSSLX.js")).default;
var preloadScanIcon = () => loadImages(src6);
var ScanIcon = () => import_react70.default.createElement(
  AsyncImage,
  {
    background: "#515a70",
    borderColor: "generalBorder",
...
function QRCode({
  ...
  return import_react71.default.createElement(
    ...
    import_react71.default.createElement(
      ...
      import_react71.default.createElement(Cuer.Root, { errorCorrection: ecc, size: size4, value: uri }, import_react71.default.createElement(Cuer.Cells, { radius: 1 }), import_react71.default.createElement(Cuer.Finder, { radius: 0.25 }), resolvedLogoUrl && import_react71.default.createElement(Cuer.Arena, null, import_react71.default.createElement(
        "img",
        {
          alt: "Wallet Logo",
          src: resolvedLogoUrl,
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Arc":
      return (await import("./Arc-VDBY7LNS-P7IRLQE7.js")).default;
    case "Brave":
      return (await import("./Brave-BRAKJXDS-BJJWOHUZ.js")).default;
    case "Chrome":
      return (await import("./Chrome-65Q5P54Y-P4HQ5FXP.js")).default;
    case "Edge":
      return (await import("./Edge-XSPUTORV-P36WUHWC.js")).default;
    case "Firefox":
      return (await import("./Firefox-AAHGJQIP-RSVKQBKL.js")).default;
    case "Opera":
      return (await import("./Opera-KQZLSACL-ON4FT3SB.js")).default;
    case "Safari":
      return (await import("./Safari-ZPL37GXR-RPUGDLI6.js")).default;
    default:
      return (await import("./Browser-76IHF3Y2-ETVLHXBP.js")).default;
  }
};
...
var getPlatformSrc = async () => {
  ...
  switch (platform) {
    case "Windows":
      return (await import("./Windows-PPTHQER6-GBFBUUMK.js")).default;
    case "macOS":
      return (await import("./Macos-MW4AE7LN-SJI2RPM5.js")).default;
    case "Linux":
      return (await import("./Linux-OO4TNCLJ-RVPNSMAN.js")).default;
    default:
      return (await import("./Linux-OO4TNCLJ-RVPNSMAN.js")).default;
  }
};
...
function GetDetail({
  ...
  return import_react66.default.createElement(
      ...
      shownWallets?.filter(
        ...
        return import_react66.default.createElement(
          ...
          import_react66.default.createElement(
            ...
            import_react66.default.createElement(Box, { display: "flex", flexDirection: "column", gap: "2" }, import_react66.default.createElement(Text, { color: "modalText", size: "14", weight: "bold" }, name), import_react66.default.createElement(Text, { color: "modalTextSecondary", size: "14", weight: "medium" }, hasMobileAndExtension ? i18n2.t("get.mobile_and_extension.description") : hasMobileAndDesktop ? i18n2.t("get.mobile_and_desktop.description") : hasMobileCompanionApp ? i18n2.t("get.mobile.description") : hasExtension ? i18n2.t("get.extension.description") : null))
          ),
          import_react66.default.createElement(Box, { display: "flex", flexDirection: "column", gap: "4" }, import_react66.default.createElement(
            ActionButton,
            {
    ...
    import_react66.default.createElement(
      ...
      import_react66.default.createElement(Text, { color: "modalText", size: "14", weight: "bold" }, i18n2.t("get.looking_for.title")),
      import_react66.default.createElement(Text, { color: "modalTextSecondary", size: "14", weight: "medium" }, compactModeEnabled ? i18n2.t("get.looking_for.desktop.compact_description") : i18n2.t("get.looking_for.desktop.wide_description"))
    )
  );
}
var LOGO_SIZE = "44";
function ConnectDetail({
  ...
  return import_react66.default.createElement(Box, { display: "flex", flexDirection: "column", height: "full", width: "full" }, hasQrCode ? import_react66.default.createElement(
    Box,
    {
      alignItems: "center",
      display: "flex",
    ...
    import_react66.default.createElement(
      ...
      import_react66.default.createElement(Box, { borderRadius: "10", height: LOGO_SIZE, overflow: "hidden" }, import_react66.default.createElement(
        AsyncImage,
        {
      ...
      import_react66.default.createElement(
        ...
        import_react66.default.createElement(Text, { color: "modalText", size: "18", weight: "bold" }, ready ? i18n2.t("connect.status.opening", {
          wallet: name
        ...
        !ready && hasExtension ? import_react66.default.createElement(Box, { paddingTop: "20" }, import_react66.default.createElement(
          ActionButton,
          {
        ...
        ready && !hasQrCode && import_react66.default.createElement(import_react66.default.Fragment, null, import_react66.default.createElement(
          Box,
          {
            alignItems: "center",
            display: "flex",
          ...
          connectionError ? import_react66.default.createElement(
            ActionButton,
            {
          ...
          ) : import_react66.default.createElement(Box, { color: "modalTextSecondary" }, import_react66.default.createElement(SpinnerIcon, null))
        ))
      )
    )
  ), import_react66.default.createElement(
    ...
    ready && secondaryAction && import_react66.default.createElement(import_react66.default.Fragment, null, import_react66.default.createElement(Text, { color: "modalTextSecondary", size: "14", weight: "medium" }, secondaryAction.description), import_react66.default.createElement(
      ActionButton,
      {
...
var DownloadOptionsBox = ({
  ...
  return import_react66.default.createElement(
    ...
    isBrowserCard && import_react66.default.createElement(
      Box,
      {
    ...
    !isBrowserCard && gradientRgbas && import_react66.default.createElement(
      Box,
      {
    ...
    import_react66.default.createElement(
      ...
      import_react66.default.createElement(
        ...
        import_react66.default.createElement(Text, { color: "modalText", size: "14", weight: "bold" }, title),
        import_react66.default.createElement(Text, { color: "modalTextSecondary", size: "14", weight: "medium" }, description),
        import_react66.default.createElement(Box, { marginTop: "14", width: "max" }, import_react66.default.createElement(
          ActionButton,
          {
            href: url,
            label: actionLabel,
...
function DownloadOptionsDetail({
  ...
  return import_react66.default.createElement(
    ...
    import_react66.default.createElement(
      ...
      extensionDownloadUrl && import_react66.default.createElement(
        DownloadOptionsBox,
        {
      ...
      desktopDownloadUrl && import_react66.default.createElement(
        DownloadOptionsBox,
        {
      ...
      mobileDownloadUrl && import_react66.default.createElement(
        DownloadOptionsBox,
        {
...
function DownloadDetail({
  ...
  return import_react66.default.createElement(
    ...
    import_react66.default.createElement(Box, { style: { maxWidth: 220, textAlign: "center" } }, import_react66.default.createElement(Text, { color: "modalTextSecondary", size: "14", weight: "semibold" }, i18n2.t("get_mobile.description"))),
    import_react66.default.createElement(Box, { height: "full" }, downloadUrls?.qrCode ? import_react66.default.createElement(QRCode, { logoSize: 0, size: 268, uri: downloadUrls.qrCode }) : null),
    import_react66.default.createElement(
      Box,
      {
        alignItems: "center",
...
var stepIcons = {
  ...
  install: (wallet) => import_react66.default.createElement(
    AsyncImage,
    {
...
function InstructionMobileDetail({
  ...
  return import_react66.default.createElement(
    ...
    import_react66.default.createElement(
      ...
      wallet?.qrCode?.instructions?.steps.map((d, idx) => import_react66.default.createElement(
        Box,
        {
          alignItems: "center",
          display: "flex",
        ...
        import_react66.default.createElement(Box, { display: "flex", flexDirection: "column", gap: "4" }, import_react66.default.createElement(Text, { color: "modalText", size: "14", weight: "bold" }, i18n2.t(d.title, void 0, {
          rawKeyIfTranslationMissing: true
        })), import_react66.default.createElement(Text, { color: "modalTextSecondary", size: "14", weight: "medium" }, i18n2.t(d.description, void 0, {
          rawKeyIfTranslationMissing: true
        })))
      ))
    ),
    import_react66.default.createElement(
      ...
      import_react66.default.createElement(
        ...
        import_react66.default.createElement(Text, { color: "accentColor", size: "14", weight: "bold" }, i18n2.t("get_instructions.mobile.learn_more.label"))
      )
    )
  );
}
function InstructionExtensionDetail({
  ...
  return import_react66.default.createElement(
    ...
    import_react66.default.createElement(
      ...
      wallet?.extension?.instructions?.steps.map((d, idx) => import_react66.default.createElement(
        Box,
        {
          alignItems: "center",
          display: "flex",
    ...
    import_react66.default.createElement(
      ...
      import_react66.default.createElement(
        ...
        import_react66.default.createElement(Text, { color: "accentColor", size: "14", weight: "bold" }, i18n2.t("get_instructions.extension.learn_more.label"))
      )
    )
  );
}
function InstructionDesktopDetail({
  ...
  return import_react66.default.createElement(
    ...
    import_react66.default.createElement(
      ...
      wallet?.desktop?.instructions?.steps.map((d, idx) => import_react66.default.createElement(
        Box,
        {
          alignItems: "center",
          display: "flex",
    ...
    import_react66.default.createElement(
      ...
      import_react66.default.createElement(
        ...
        import_react66.default.createElement(Text, { color: "accentColor", size: "14", weight: "bold" }, i18n2.t("get_instructions.desktop.learn_more.label"))
      )
    )
  );
}
function DesktopOptions({ onClose }) {
  ...
  switch (walletStep) {
    case "NONE":
      walletContent = import_react57.default.createElement(ConnectModalIntro, { getWallet: () => changeWalletStep(
        "GET"
        /* Get */
      ) });
      break;
    case "LEARN_COMPACT":
      walletContent = import_react57.default.createElement(
        ConnectModalIntro,
        {
          compactModeEnabled,
    ...
    case "GET":
      ...
      break;
    case "CONNECT":
      walletContent = selectedWallet && import_react57.default.createElement(
        ConnectDetail,
        {
          changeWalletStep,
          compactModeEnabled,
    ...
    case "INSTRUCTIONS_EXTENSION":
      walletContent = selectedWallet && import_react57.default.createElement(InstructionExtensionDetail, { wallet: selectedWallet });
      headerLabel = selectedWallet && i18n2.t("get_options.title", {
        wallet: compactModeEnabled ? selectedWallet.shortName || selectedWallet.name : selectedWallet.name
      });
  ...
  return import_react57.default.createElement(
    ...
    (compactModeEnabled ? walletStep === "NONE" : true) && import_react57.default.createElement(
      Box,
      {
      ...
      import_react57.default.createElement(Box, { display: "flex", justifyContent: "space-between" }, compactModeEnabled && Disclaimer && import_react57.default.createElement(Box, { marginLeft: "16", width: "28" }, import_react57.default.createElement(
        InfoButton,
        {
          onClick: () => changeWalletStep(
            "LEARN_COMPACT"
      ...
      )), compactModeEnabled && !Disclaimer && import_react57.default.createElement(Box, { marginLeft: "16", width: "28" }), import_react57.default.createElement(
        Box,
        {
      ...
      ), compactModeEnabled && import_react57.default.createElement(Box, { marginRight: "16" }, import_react57.default.createElement(CloseButton, { onClose }))),
      import_react57.default.createElement(Box, { className: ScrollClassName, paddingBottom: "18" }, Object.entries(groupedWallets).map(
        ([groupName, wallets2], index) => wallets2.length > 0 && import_react57.default.createElement(import_react57.Fragment, { key: index }, groupName ? import_react57.default.createElement(Box, { marginBottom: "8", marginTop: "16", marginX: "6" }, import_react57.default.createElement(
          Text,
          {
        ...
        )) : null, import_react57.default.createElement(Box, { display: "flex", flexDirection: "column", gap: "4" }, wallets2.map((wallet) => {
          return import_react57.default.createElement(
            ModalSelection,
            {
      ...
      compactModeEnabled && import_react57.default.createElement(import_react57.default.Fragment, null, import_react57.default.createElement(Box, { background: "generalBorder", height: "1", marginTop: "-1" }), Disclaimer ? import_react57.default.createElement(Box, { paddingX: "24", paddingY: "16", textAlign: "center" }, import_react57.default.createElement(Disclaimer, { Link: DisclaimerLink, Text: DisclaimerText })) : import_react57.default.createElement(
        Box,
        {
          alignItems: "center",
          display: "flex",
        ...
        import_react57.default.createElement(Box, { paddingY: "4" }, import_react57.default.createElement(Text, { color: "modalTextSecondary", size: "14", weight: "medium" }, i18n2.t("connect.new_to_ethereum.description"))),
        import_react57.default.createElement(
          Box,
          {
            alignItems: "center",
          ...
          import_react57.default.createElement(
            ...
            import_react57.default.createElement(Text, { color: "accentColor", size: "14", weight: "bold" }, i18n2.t("connect.new_to_ethereum.learn_more.label"))
          )
        )
      ))
    ),
    (compactModeEnabled ? walletStep !== "NONE" : true) && import_react57.default.createElement(import_react57.default.Fragment, null, !compactModeEnabled && import_react57.default.createElement(Box, { background: "generalBorder", minWidth: "1", width: "1" }), import_react57.default.createElement(
      Box,
      {
        display: "flex",
        flexDirection: "column",
      ...
      import_react57.default.createElement(
        ...
        import_react57.default.createElement(Box, { width: "28" }, headerBackButtonLink && import_react57.default.createElement(
          Box,
          {
            as: "button",
            className: touchableStyles({
          ...
          import_react57.default.createElement(BackIcon, null)
        )),
        import_react57.default.createElement(
          Box,
          {
          ...
          headerLabel && import_react57.default.createElement(
            Text,
            {
              color: "modalText",
              size: "18",
        ...
        import_react57.default.createElement(CloseButton, { onClose })
      ),
      import_react57.default.createElement(
        Box,
        {
...
var LoadingSpinner = ({ wallet }) => {
  ...
  return import_react72.default.createElement("svg", { className: spinner, viewBox: "0 0 86 86", width: "86", height: "86" }, import_react72.default.createElement("title", null, "Loading"), import_react72.default.createElement(
    "rect",
    {
      x: "3",
      y: "3",
  ...
  return import_react72.default.createElement(
    ...
    import_react72.default.createElement(
      ...
      import_react72.default.createElement(
        ...
        connecting ? import_react72.default.createElement(LoadingSpinner, { wallet }) : null,
        import_react72.default.createElement(
          AsyncImage,
          {
            background: iconBackground,
      ...
      !connecting ? import_react72.default.createElement(Box, { display: "flex", flexDirection: "column", textAlign: "center" }, import_react72.default.createElement(
        Text,
        {
          as: "h2",
        ...
        import_react72.default.createElement(Box, { as: "span", position: "relative" }, shortName ?? name, !wallet.ready && " (unsupported)")
      ), wallet.recent && import_react72.default.createElement(Text, { color: "accentColor", size: "12", weight: "medium" }, i18n2.t("connect.recent"))) : null
    )
  );
}
function MobileOptions({ onClose }) {
  ...
  switch (walletStep) {
    case "CONNECT": {
      ...
      walletContent = import_react72.default.createElement(Box, null, import_react72.default.createElement(
        Box,
        {
        ...
        import_react72.default.createElement(Box, { display: "flex", style: { margin: "0 auto" } }, wallets.filter((wallet) => wallet.ready).map((wallet) => {
          return import_react72.default.createElement(Box, { key: wallet.id, paddingX: "20" }, import_react72.default.createElement(Box, { width: "60" }, import_react72.default.createElement(WalletButton, { onClose, wallet })));
        }))
      ), import_react72.default.createElement(
        Box,
        {
        ...
        import_react72.default.createElement(
          ...
          import_react72.default.createElement(Text, { color: "modalText", size: "16", weight: "bold" }, i18n2.t("intro.title")),
          import_react72.default.createElement(Text, { color: "modalTextSecondary", size: "16" }, i18n2.t("intro.description"))
        )
      ), import_react72.default.createElement(Box, { paddingTop: "32", paddingX: "20" }, import_react72.default.createElement(Box, { display: "flex", gap: "14", justifyContent: "center" }, import_react72.default.createElement(
        ActionButton,
        {
      ...
      ))), Disclaimer && import_react72.default.createElement(Box, { marginTop: "28", marginX: "32", textAlign: "center" }, import_react72.default.createElement(Disclaimer, { Link: DisclaimerLink, Text: DisclaimerText })));
      break;
    }
    case "GET": {
      headerLabel = i18n2.t("get.title");
      ...
      walletContent = import_react72.default.createElement(Box, null, import_react72.default.createElement(
        ...
        mobileWallets.map((wallet, index) => {
          ...
          return import_react72.default.createElement(
            ...
            import_react72.default.createElement(Box, { style: { minHeight: 48, minWidth: 48 } }, import_react72.default.createElement(
              AsyncImage,
              {
                background: iconBackground,
                borderColor: "generalBorder",
            ...
            import_react72.default.createElement(Box, { display: "flex", flexDirection: "column", width: "full" }, import_react72.default.createElement(Box, { alignItems: "center", display: "flex", height: "48" }, import_react72.default.createElement(Box, { width: "full" }, import_react72.default.createElement(Text, { color: "modalText", size: "18", weight: "bold" }, name)), import_react72.default.createElement(
              ActionButton,
              {
            ...
            )), index < mobileWallets.length - 1 && import_react72.default.createElement(
              Box,
              {
                background: "generalBorderDim",
                height: "1",
      ...
      ), import_react72.default.createElement(Box, { style: { marginBottom: "42px" } }), import_react72.default.createElement(
        Box,
        {
          alignItems: "center",
          display: "flex",
        ...
        import_react72.default.createElement(
          ...
          import_react72.default.createElement(Text, { color: "modalText", size: "16", weight: "bold" }, i18n2.t("get.looking_for.title")),
          import_react72.default.createElement(Text, { color: "modalTextSecondary", size: "16" }, i18n2.t("get.looking_for.mobile.description"))
        )
      ));
      break;
    }
  }
  return import_react72.default.createElement(Box, { display: "flex", flexDirection: "column", paddingBottom: "36" }, import_react72.default.createElement(
    Box,
    {
    ...
    import_react72.default.createElement(
      ...
      headerBackButtonLink && import_react72.default.createElement(
        Box,
        {
          display: "flex",
          position: "absolute",
        ...
        import_react72.default.createElement(
          ...
          import_react72.default.createElement(BackIcon, null)
        )
      ),
      import_react72.default.createElement(Box, { marginTop: "4", textAlign: "center", width: "full" }, import_react72.default.createElement(
        Text,
        {
          as: "h1",
          color: "modalText",
      ...
      import_react72.default.createElement(
        ...
        import_react72.default.createElement(
          ...
          import_react72.default.createElement(CloseButton, { onClose })
        )
      )
    )
  ), import_react72.default.createElement(Box, { display: "flex", flexDirection: "column" }, walletContent));
}
var MobileStatus = ({ onClose }) => {
  ...
  return import_react73.default.createElement(Box, null, import_react73.default.createElement(
    Box,
    {
      display: "flex",
      paddingBottom: "32",
    ...
    import_react73.default.createElement(Box, { width: "60" }, import_react73.default.createElement(WalletButton, { onClose, wallet: connector, connecting: true })),
    import_react73.default.createElement(Box, { marginTop: "20" }, import_react73.default.createElement(
      Text,
      {
        textAlign: "center",
        color: "modalText",
    ...
    import_react73.default.createElement(Box, { maxWidth: "full", marginTop: "8" }, import_react73.default.createElement(Text, { textAlign: "center", color: "modalText", size: "16", weight: "medium" }, i18n2.t("connect.status.confirm_mobile", {
      wallet: connectorName
    })))
  ));
};
function ConnectOptions({ onClose }) {
  ...
  return isMobile() ? connector ? import_react56.default.createElement(MobileStatus, { onClose }) : import_react56.default.createElement(MobileOptions, { onClose }) : import_react56.default.createElement(DesktopOptions, { onClose });
}
function ConnectModal({ onClose, open }) {
  ...
  if (connectionStatus === "disconnected") {
    return import_react55.default.createElement(Dialog, { onClose: onConnectModalCancel, open, titleId }, import_react55.default.createElement(DialogContent, { bottomSheetOnMobile: true, padding: "0", wide: true }, import_react55.default.createElement(ConnectOptions, { onClose: onConnectModalCancel })));
  }
  if (connectionStatus === "unauthenticated") {
    return import_react55.default.createElement(Dialog, { onClose: onAuthCancel, open, titleId }, import_react55.default.createElement(DialogContent, { bottomSheetOnMobile: true, padding: "0" }, import_react55.default.createElement(SignIn, { onClose: onAuthCancel, onCloseModal: onClose })));
  }
  return null;
}
...
function ModalProvider({ children }) {
  ...
  const [isWalletConnectModalOpen, setIsWalletConnectModalOpen] = (0, import_react18.useState)(false);
  const connectionStatus = useConnectionStatus();
  const { chainId } = useAccount();
  const { chains } = useConfig();
  const isCurrentChainSupported = chains.some((chain) => chain.id === chainId);
  const closeModals = (0, import_react18.useCallback)(
  ...
  return import_react18.default.createElement(
    ...
    children,
    import_react18.default.createElement(ConnectModal, { onClose: closeConnectModal, open: connectModalOpen }),
    import_react18.default.createElement(AccountModal, { onClose: closeAccountModal, open: accountModalOpen }),
    import_react18.default.createElement(ChainModal, { onClose: closeChainModal, open: chainModalOpen })
  );
}
...
function useWalletConnectOpenState() {
  const { isWalletConnectModalOpen, setIsWalletConnectModalOpen } = (0, import_react18.useContext)(ModalContext);
...
function ConnectButton({
  ...
  return ready ? import_react.default.createElement(ConnectButtonRenderer, null, ({
    account,
    chain,
    mounted,
    openAccountModal,
    ...
    return import_react.default.createElement(
      ...
      ready2 && account && connectionStatus === "connected" ? import_react.default.createElement(import_react.default.Fragment, null, chain && (chains.length > 1 || unsupportedChain) && import_react.default.createElement(
        Box,
        {
          alignItems: "center",
        ...
        unsupportedChain ? import_react.default.createElement(
          Box,
          {
            alignItems: "center",
            display: "flex",
        ...
        ) : import_react.default.createElement(Box, { alignItems: "center", display: "flex", gap: "6" }, chain.hasIcon ? import_react.default.createElement(
          Box,
          {
            display: mapResponsiveValue(
              chainStatus,
        ...
        ) : null, import_react.default.createElement(
          Box,
          {
        ...
        import_react.default.createElement(DropdownIcon, null)
      ), !unsupportedChain && import_react.default.createElement(
        Box,
        {
          alignItems: "center",
        ...
        account.displayBalance && import_react.default.createElement(
          Box,
          {
            display: mapResponsiveValue(
              showBalance,
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement(
            ...
            import_react.default.createElement(Box, { alignItems: "center", display: "flex", gap: "6" }, import_react.default.createElement(
              Box,
              {
                display: mapResponsiveValue(
                  accountStatus,
...
var WalletButton2 = ({ wallet }) => {
  return import_react74.default.createElement(WalletButtonRenderer, { wallet }, ({ ready, connect, connected, mounted, connector, loading }) => {
      ...
      import_react74.default.createElement(
        ...
        import_react74.default.createElement(
          ...
          import_react74.default.createElement(
            ...
            import_react74.default.createElement(Box, null, loading ? import_react74.default.createElement(SpinnerIcon, null) : import_react74.default.createElement(
              AsyncImage,
              {
            ...
            import_react74.default.createElement(
              ...
              import_react74.default.createElement(Box, { testId: `wallet-button-label-${connector?.id || ""}` }, loading ? i18n2.t("connect.status.connecting", {
                wallet: connectorName
              }) : connectorName)
            ),
            connected ? import_react74.default.createElement(
              Box,
              {
                background: "connectionIndicator",
                borderColor: "selectedOptionBorder",
...
var baseAccount2 = ({ appName, appIcon }) => {
  return {
    ...
    rdns: "app.base.account",
    iconUrl: async () => (await import("./baseAccount-44UITRK7-7C6XMIYS.js")).default,
    iconAccent: "#0000FF",
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-SITXT2FV-DMHNWDX6.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var rainbowWallet = ({
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-O26YNBMX-UCVFC4SO.js")).default,
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-5MNKTR5Z-WUE2APA6.js")).default,
  installed: (
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-YHWKVTDY-WWBE4CDH.js")).default,
